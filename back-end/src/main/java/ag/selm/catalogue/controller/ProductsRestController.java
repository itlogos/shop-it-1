...
import ag.selm.catalogue.controller.payload.NewProductDto;
...
public class ProductsRestController {
    ...
    public ResponseEntity<?> createProduct(@Valid @RequestBody NewProductDto payload,
        ...
        if (bindingResult.hasErrors()) {
            ...
            Product product = this.productService.createProduct(payload.title(), payload.price(), payload.details());

...
import ag.selm.manager.controller.payload.NewProductDto;
...
public class ProductsController {
    ...
    public String createProduct(NewProductDto payload,
                                Model model) {
        try {
            Product product = this.productsRestClient.createProduct(payload.title(), payload.price(), payload.details());
